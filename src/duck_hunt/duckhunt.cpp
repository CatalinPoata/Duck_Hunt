...
void DH::Update(float deltaTimeSeconds)
{
    if (lives > 0) {
...
void DH::OnInputUpdate(float deltaTime, int mods)
{
}


void DH::OnKeyPress(int key, int mods)
{
    // Add key press event
    if (key == GLFW_KEY_R) {
        currX = 0;
...
void DH::OnKeyRelease(int key, int mods)
{
    // Add key release event
}


void DH::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
...
void DH::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{ 
...
void DH::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
    // Add mouse button release event
}


void DH::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}


void DH::OnWindowResize(int width, int height)
{
